...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Apr 30 14:58:03 2016
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
build/moc_qrcodedialog.cpp: src/qt/qrcodedialog.h
	/usr/local/Cellar/qt/4.8.6/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/qrcodedialog.h -o build/moc_qrcodedialog.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/2Give-Export32.png \
		src/qt/res/icons/2Give-Heart.png \
		src/qt/res/icons/filesave.png \
		src/qt/res/icons/receive.png \
		src/qt/res/icons/edit.png \
		src/qt/res/icons/cwc-icon-give-small.png \
		src/qt/res/icons/2Give-Rewards16.png \
		src/qt/res/icons/cwc-icon-send-big.png \
		src/qt/res/icons/2Give-Interest16.png \
		src/qt/res/icons/2Give-Rewards20.png \
		src/qt/res/icons/remove.png \
		src/qt/res/icons/coin-icon-qrcode-big64.png \
...
build/ui_qrcodedialog.h: src/qt/forms/qrcodedialog.ui \
		src/qt/bitcoinamountfield.h
	/usr/local/Cellar/qt/4.8.6/bin/uic src/qt/forms/qrcodedialog.ui -o build/ui_qrcodedialog.h
