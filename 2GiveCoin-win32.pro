...
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE MINIUPNP_STATICLIB CURL_STATICLIB
...
LIBS += -lssl -lcrypto -lpcre -lcurl -lidn -lgnutls -lnettle -ldb_cxx$$BDB_LIB_SUFFIX
...
# need some sort of voodoo here to work around
# http://stackoverflow.com/questions/13768515/how-to-do-static-linking-of-libwinpthread-1-dll-in-mingw
# ... try 'strings 2givecoin-qt.exe | grep libwinpthread'
win32:LIBS += -static -static-libgcc -static-libstdc++ -lpthread 
